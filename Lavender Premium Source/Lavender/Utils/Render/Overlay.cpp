...
void CreateDeviceD3D()
{
	...
	{
#ifdef _DEBUG
		std::cout << xorstr_("[ERROR : FrameWork::Window::InitializeDirectX11::D3D11CreateDeviceAndSwapChain] Error: ") << SafeCall(GetLastError)() << std::endl;
#endif // _DEBUG
...
namespace FrameWork
{
	void Overlay::Setup(DWORD TargetPid)
	{
		...
		{
#ifdef _DEBUG
			std::cout << xorstr_("[ERROR : FrameWork::Window::Setup] Window Not Found!") << std::endl;
#endif // _DEBUG
		}
	}
	...
	void Overlay::Initialize()
	{
		...
		{
#ifdef _DEBUG
			std::cout << xorstr_("[ERROR : FrameWork::Window::Initialize] Overlay Not Settuped!") << std::endl;
#endif // _DEBUG
		...
		WindowClass.lpszClassName = xorstr_(L"Window");
		...
		{
#ifdef _DEBUG
			std::cout << xorstr_("[ERROR : FrameWork::Window::Initialize::RegisterClassEx] Error: ") << SafeCall(GetLastError)() << std::endl;
#endif // _DEBUG
		...
		{
#ifdef _DEBUG
			std::cout << xorstr_("[ERROR : FrameWork::Window::Initialize::CreateWindowEx] Error: ") << SafeCall(GetLastError)() << std::endl;
#endif // _DEBUG
