...
namespace ImGui
{
    ...
    IMGUI_API ImU32         xGetColorU32(const ImVec4& col, float alpha_mul = 1.f);
    ...
    IMGUI_API bool          SolTab(bool selected, const char* icon, const char* label, const char* description, const ImVec2& size_arg);
    ...
    IMGUI_API bool          CheckboxNew(const char* label, const char* description, bool* v);
    ...
    IMGUI_API bool          BeginCombo(const char* label, const char* description, const char* preview_value, int val = 0, bool multi = false, ImGuiComboFlags flags = 0);
    ...
    IMGUI_API bool          ColorEdit4New(const char* label, const char* description, float col[4], ImGuiColorEditFlags flags = 0);
...
struct ImDrawList
{
    ...
    IMGUI_API void  xAddRectFilledMultiColor(const ImVec2& p_min, const ImVec2& p_max, ImU32 col_upr_left, ImU32 col_upr_right, ImU32 col_bot_right, ImU32 col_bot_left, float rounding = 0.f, ImDrawFlags flags = 0.f);
