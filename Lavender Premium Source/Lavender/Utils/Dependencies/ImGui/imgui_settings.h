...
namespace font
{
	...
	inline ImFont* lexend_visuals = nullptr;
	inline ImFont* lexend_general_bold = nullptr;
	inline ImFont* lexend_general_ultrabold = nullptr;
	inline ImFont* slogan = nullptr;
	inline ImFont* main = nullptr;
	inline ImFont* copyright = nullptr;
	inline IDirect3DTexture9* brand_img;
	inline ImFont* icomoon_widget = nullptr;
	inline ImFont* icomoon_widget2 = nullptr;
	inline ImFont* menuFnt = nullptr;
	inline ImFont* menuBoldFont = nullptr;
